...
print("params loaded in good job")
...
print("refFile loaded in good job")

#testFile <- "MuraroPancreasData"

if (location == "external") {
  datasets <- scRNAseq::listDatasets()
  print("datasets found good job")
  testFileName <- paste0(testFile, "()")
  print("testfilename differentiated good job")
  if (testFileName %in% datasets@listData[["Call"]]) {
    ...
    print("testfile called from scRNAseq good job")
...
print("testfile all set... great job")
```
...
table(pred$labels)
print("SingleR comparison complete. About to make graphs.")
setwd(imageDir)
